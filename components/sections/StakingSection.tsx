...
import { 
  ...
  LayoutGrid, Zap, ArrowUpCircle, Check, TrendingUp, Clock, ExternalLink, Loader2,Play
} from 'lucide-react';
    ...
    <div className="relative p-1">
      ...
      <AnimatePresence>
        {claimResult?.isOpen && (
          ...
          >
            <div className="bg-[#161A1E] border border-green-500/30 w-full max-w-sm rounded-3xl p-8 text-center relative overflow-hidden">
      ...
      <AnimatePresence>
        {unstakeResult?.isOpen && (
          <motion.div 
            ...
            className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-md p-4"
          >
            <div className="bg-[#161A1E] border border-white/10 w-full max-w-sm rounded-3xl overflow-hidden shadow-2xl">
      ...
      <AnimatePresence>
        {unstakeModal.isOpen && unstakeModal.record && (
          ...
          >
            <div className="bg-[#12141a] border border-white/10 w-full max-w-md rounded-2xl p-6 shadow-2xl relative overflow-hidden">
      ...
      <div className="flex items-center justify-between gap-4 mb-8">
         <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-3xl font-bold text-white">Yield Farming</h2>
              <p className="text-slate-400">Stake assets to earn KIKI</p>
            </div>
         </div>
         <div className="bg-green-500/10 text-green-400 text-xs px-3 py-1 rounded font-mono border border-green-500/20 hidden md:flex items-center gap-2">
            <Zap className="w-3 h-3 fill-current" /> Rate: {totalRate.toFixed(2)} /s
         </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 border-b border-white/5 pb-4">
              ...
              <h3 className="font-bold text-white">Available to Stake</h3>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 border-b border-white/5 pb-4">
              ...
              <h3 className="font-bold text-white">Active Vault</h3>
            </div>
            ...
            <div className="max-h-[600px] overflow-y-auto pr-2 custom-scrollbar space-y-3">
              {isLoading ? (
                 <div className="flex flex-col items-center justify-center py-20 text-slate-500 text-sm gap-3">
                   <Loader2 className="animate-spin w-6 h-6 text-green-500"/> Syncing...
                 </div>
              ) : stakedNfts.length === 0 ? (

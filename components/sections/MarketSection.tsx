...
import { 
  ...
  Store, CheckCircle2, List, Trash2, AlertCircle, X, ShoppingBag, Gavel
} from 'lucide-react';
  ...
  return (
    <div className="relative p-1">
      ...
      <div className="flex items-center gap-4 mb-8">
         ...
         <div>
            <h2 className="text-3xl font-bold text-white">Black Market</h2>
            <p className="text-slate-400">P2P Asset Exchange</p>
         </div>
      </div>
      ...
      <div className="min-h-[400px]">
          ...
          {activeTab === 'sell' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
               {/* Inventory Grid */}
               <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-4 max-h-[500px] overflow-y-auto custom-scrollbar">
